...
import com.example.vells.ui.configuration.viewmodel.ConfigurationViewModel
...
class ViewModelFactory(private val dbRoom: DbRoom): ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        ...
        return when (modelClass) {
            ...
            ConfigurationViewModel::class.java -> ConfigurationViewModel(GlobalRepositoryUseCase(dbRoom)) as T
